    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "تم تغيير كلمة السر الخاصة بك بنجاح"
                : message == ManageMessageId.SetPasswordSuccess ? "تم إنشاء كلمة المرور الخاصة بك بنجاح"
                : message == ManageMessageId.SetTwoFactorSuccess ? "Your two-factor authentication provider has been set."
                : message == ManageMessageId.Error ? "حدث خطأ ما"
                : message == ManageMessageId.AddPhoneSuccess ? "تم إضافة رقم هاتفك"
                : message == ManageMessageId.RemovePhoneSuccess ? "تم إزالة رقم هاتفك"
                : "";
